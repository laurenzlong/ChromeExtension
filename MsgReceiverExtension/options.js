jQuery(function($){
  ...
  if (id == 0){
    var c = createQuery(++id);
    c.find('.url').val('https://docs.google.com/forms/d/19B28hXsgQE2OiCtIoHstAIIIpAgflT4CJ6QfUjmT-B4/viewform');
    c.find('.query').val('input[aria-label="Address  "  ]');
    c.find('.value').val('12 Example Street');
